...
<head>
  ...
  <title><?php echo $_sys_setting->setting_web_name ?> | Registrasi Page</title>
...
<div class="login-box" style="margin: 3% auto;">
  <div class="login-logo">
    ...
    <div class="row">
      <div class="col-12 ">
        <div>SISTEM PAKAR<b style="letter-spacing:1.5px;"><br/><h4>Registrasi User</h4></b></div>
      </div>
    </div>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form id="form" action="<?php echo base_url('auth/register') ?>">
        <div class="form-group has-feedback">
          <label>Username</label>
          <div class="input-group">
              <input type="text" autocomplete="off" id="username" name="user_username" class="form-control" placeholder="Masukkan Username">
        ...
        <div class="form-group has-feedback">
          <label>Email</label>
          <div class="input-group">
              <input type="text" autocomplete="off" id="username" name="user_email" class="form-control" placeholder="Masukkan Email">
              <div class="input-group-append">
                <span class="input-group-text form-control-feedback"><i class="fa fa-user"></i></span>
              </div>
          </div>
        ...
        <div class="form-group has-feedback">
          <label>ReType Passsword</label>
          <div class="input-group">
              <input type="password" autocomplete="off" id="password" name="password2" class="form-control" placeholder="Masukkan Password">
              <div class="input-group-append">
                <span class="input-group-text form-control-feedback"><i class="fa fa-key"></i></span>
              </div>
          </div>
        </div>
        <a href="<?= base_url('auth/login') ?>">Punya Akun?</a>
        <div><hr></div>
