...
<div class="login-box" style="margin: 3% auto;">
  <div class="login-logo">
    ...
    <div class="row">
      <div class="col-12 ">
        <div>SISTEM PENDUKUNG KEPUTUSAN<b style="letter-spacing:1.5px;"><br/><h4><?php echo $_sys_setting->setting_web_name ?></h4></b></div>
      </div>
    </div>
  </div>
  <!-- /.login-logo -->
    ...
    <div class="card-body login-card-body">
      ...
      <form id="form" action="<?php echo base_url('auth/check_login') ?>">
        ...
        <div class="d-block" align="center">
            ...
            <!-- <a href="<?= base_url('auth/registrasi') ?>" class="btn btn-success">Daftar User</a> -->
        </div>
      </form>
    </div>
    <!-- /.login-card-body -->
