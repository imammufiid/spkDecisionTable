...
<script type="text/javascript">
	$(document).ready(function() {
		var tabel = $('#tabel-data').DataTable({
			ajax: {
				url: "<?php echo base_url('condition/fetch') ?>",
				dataSrc: "data",
				"type": "POST",
				'dataType': 'json',
			},
	...
	function dt_add(t) {
		$.get('<?php echo base_url('condition/modal/add') ?>').done(function(data) {
	...
	function dt_edit(t) {
		$.get('<?php echo base_url('/condition/modal/edit') ?>', {
			'id': $(t).attr('target-id')
		}).done(function(data) {
	...
	function dt_delete(t) {
		$.get('<?php echo base_url('condition/modal/delete') ?>', {
			'id': $(t).attr('target-id')
		}).done(function(data) {
